          ...
          <form className="flex flex-col gap-5" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <button type="button" className="text-sm font-bold text-primary hover:text-primary-dark transition-colors">Quên mật khẩu?</button>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 flex flex-col gap-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs font-bold text-slate-400 uppercase">
                <span className="bg-white px-4">Hoặc đăng nhập bằng</span>
              </div>
            </div>
