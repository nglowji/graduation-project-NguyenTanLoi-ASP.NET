...
const Revenue: React.FC = () => {
  ...
  return <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="mx-auto flex max-w-[1500px] flex-col gap-5 overflow-hidden pb-16">
    <header className="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/70 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex items-start gap-4"><span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-blue-600 text-white shadow-lg shadow-blue-600/20"><BarChart3 size={23} /></span><div><p className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600">Báo cáo vận hành</p><h1 className="mt-2 text-3xl font-black text-slate-950">Doanh thu sân</h1><p className="mt-2 text-sm font-semibold text-slate-500">Theo dõi tiền thu, đơn đặt và hiệu quả theo từng loại sân.</p></div></div>
